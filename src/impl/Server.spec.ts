...
describe(
	"Test getCpIdFromUrl method",
	() => {
		it(
			"should extract cp id from the url",
			() => {
		...
		it(
			"should extract cp and decode correctly",
			() => {
		...
		it(
			"should strip query parameters from uri",
			() => {
		...
		it(
			"should return undefined cp id if provided with undefined input",
			() => {
