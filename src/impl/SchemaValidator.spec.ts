...
describe(
	...
	() => {
		...
		it(
			"should throw type contstrain violation",
			() => {
				const validator = new SchemaValidator(BootNotification);
				const t = () => {
					validator.validate({
		...
		it(
			"should throw property constrain violation for long string",
			() => {
				const validator = new SchemaValidator(BootNotification);
				const t = () => {
					validator.validate({
		...
		it(
			"should throw protocol error for missing required attribute",
			() => {
				const validator = new SchemaValidator(BootNotification);
				const t = () => {
					validator.validate({
		...
		it(
			"should throw property violation for invalid enum value",
			() => {
				const validator = new SchemaValidator(BootNotification);
				const t = () => {
					validator.validate({
